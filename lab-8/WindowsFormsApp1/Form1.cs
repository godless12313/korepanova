...
namespace PhysicsApp
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // --- Настройка интерфейса Задачи 3 ---
            SetupTask3();

            // --- Настройка интерфейса Задачи 12 ---
            SetupTask12();
        }
        ...
        private void SetupTask3()
        {
            ...
            txt_Res3 = new TextBox { Location = new Point(135, y - 2), Size = new Size(100, 20), ReadOnly = true, BackColor = SystemColors.Window };
        ...
        private void SetupTask12()
        {
            ...
            txt_a = new TextBox { Location = new Point(140, y - 2), Size = new Size(80, 20) };
            ...
            txt_Res12 = new TextBox { Location = new Point(140, y - 2), Size = new Size(100, 20), ReadOnly = true, BackColor = SystemColors.Window };
        ...
        private void Btn_Calc3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double F2 = F1 * (S2 / S1);
                txt_Res3.Text = F2.ToString("F2"); // 2 знака после запятой
            }
            catch (Exception ex)
            {
        ...
        // --- Обработчик Задачи 12 ---
        private void Btn_Calc12_Click(object sender, EventArgs e)
        {
            try
            {
                double a_cm = Convert.ToDouble(txt_a.Text);
                double a_m = a_cm / 100.0; // перевод см в метры

                double V = Math.Pow(a_m, 3); // объем в м³

                // ρ воды = 1000 кг/м³, g = 10 м/с² (согласно методичке)
                double FA = 1000 * 10 * V;
